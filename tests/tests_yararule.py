...
class TestYaraComment(unittest.TestCase):
    ...
    def test_get_yara_comment(self):
        test_yara_comment = YaraComment()
        test_yara_comment.above = "above_comment"
        test_yara_comment.inline = "inline_comment"
        test_yara_comment.below = "below_comment"
        pod_yara_comment = test_yara_comment.get_yara_comment()
